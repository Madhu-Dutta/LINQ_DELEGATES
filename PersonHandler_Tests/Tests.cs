...
namespace PersonHandler_Tests {
    ...
    public class Tests {
        ...
        private string csvPath = "C:\\Users\\madhu\\Documents\\DIPLOMA\\C#-WED\\WK10-DelegatesTry2\\Dip-Seminar-Delegates-Lambda-Linq_Exercises\\Files\\processed_data.csv";// change to appropriate path
        ...
        public void TestGetString() {
            ...
            //string expected = "Thornton Mynett 5/2/2017 12:00:00 AM/5/2017";

            string result = ph.GetString(368);            
            Assert.AreEqual(expected, result);
            
            expected = "Elianore Wyley 10/11/2017 12:00:00 AM/11/2017";
            //expected = "Elianore Wyley 11/10/2017 12:00:00 AM/11/2017";
        ...
        public void TestGetAmountBornOnEachDate() {
            ...
            //Assert.AreEqual("4/11/2017 12:00:00 AM\t2", result.First());
            //Assert.AreEqual("5/8/2017 12:00:00 AM	1", result[23]);
        }
    }
}